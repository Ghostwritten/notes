## 1. Routing Traffic to Pods from Inside and Outside of a Cluster
 ...
 3. Create a temporary Pods using the image `busybox` and run a wget
...
参考官网：[deployment](https://kubernetes.io/zh/docs/concepts/workloads/controllers/deployment/)
...
参考官网：[networkpolicy](https://kubernetes.io/zh/docs/concepts/services-networking/network-policies/)
